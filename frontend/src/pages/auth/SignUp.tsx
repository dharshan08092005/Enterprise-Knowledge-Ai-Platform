    ...
    <div className="min-h-screen flex bg-linear-to-br from-slate-900 via-blue-950 to-slate-900">
      ...
      <div className="flex-1 flex items-center justify-center p-8">
        <div className="w-full max-w-md">
          ...
          {/* <p className="text-xs text-gray-500 dark:text-slate-500 text-center mt-3">
            By creating an account, you agree to our{" "}
            <a href="#" className="text-gray-500 dark:text-slate-400 hover:text-slate-300 underline">
              Terms
            </a>{" "}
            and{" "}
            <a href="#" className="text-gray-500 dark:text-slate-400 hover:text-slate-300 underline">
