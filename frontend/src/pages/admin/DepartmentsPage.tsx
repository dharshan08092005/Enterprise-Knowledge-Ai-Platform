        ...
        <div className="space-y-6">
            <div className="flex items-center justify-between">
                <div>
                    ...
                    <p className="text-gray-400 mt-1">Organize your team members and knowledge base access</p>
                </div>
                <motion.button
            ...
            {isLoading ? (
                ...
                <div className="py-20 text-center border-2 border-dashed border-white/5 rounded-3xl">
                    ...
                    <h3 className="text-white font-medium">No departments found</h3>
                    <p className="text-gray-500 text-sm mt-1">Get started by creating your first department</p>
                </div>
            ) : (
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    {filteredDepts.map((dept) => (
                        <motion.div
                            ...
                            className="p-5 rounded-2xl bg-white/5 border border-white/10 flex items-center justify-between group hover:bg-white/[0.07] transition-all cursor-pointer"
                        >
                            <div className="flex items-center gap-4">
                                ...
                                <div>
                                    ...
                                    <p className="text-xs text-gray-500 line-clamp-1">{dept.description || 'No description provided'}</p>
                                </div>
                            </div>
                            <div className="flex items-center gap-2">
                                <button className="p-2 opacity-0 group-hover:opacity-100 text-gray-500 hover:text-white transition-all">
                                    <IconSettings size={18} />
                                </button>
                                <IconChevronRight className="w-5 h-5 text-gray-700 group-hover:text-gray-400 transition-colors" />
                            </div>
                        </motion.div>
                    ))}
                </div>
                            ...
                            <form onSubmit={handleCreate} className="p-6 space-y-4">
                                ...
                                <div>
                                    ...
                                    <textarea
                                        ...
                                        className="w-full px-4 py-3 bg-white/5 border border-white/10 rounded-xl text-white focus:outline-none focus:border-purple-500/50 min-h-[100px]"
                                        placeholder="Brief purpose of this department..."
                                    />
                                </div>
                                <button
                                    disabled={isCreating}
                                    className="w-full py-4 bg-gradient-to-r from-purple-600 to-pink-600 rounded-2xl text-white font-bold shadow-lg shadow-purple-500/20 disabled:opacity-50"
                                >
