...
const mockUsers: User[] = [
    { id: "1", name: "John Doe", email: "john@example.com", role: "USER", status: "active", createdAt: "2024-01-15", lastLogin: "2 hours ago" },
    { id: "2", name: "Sarah Smith", email: "sarah@example.com", role: "USER", status: "active", createdAt: "2024-02-01", lastLogin: "1 day ago" },
    { id: "3", name: "Mike Johnson", email: "mike@example.com", role: "AUDITOR", status: "active", createdAt: "2024-01-20", lastLogin: "3 hours ago" },
    { id: "4", name: "Emily Brown", email: "emily@example.com", role: "USER", status: "inactive", createdAt: "2023-12-10", lastLogin: "30 days ago" },
    { id: "5", name: "Alex Wilson", email: "alex@example.com", role: "USER", status: "pending", createdAt: "2024-02-05", lastLogin: "Never" },
    { id: "6", name: "Jane Davis", email: "jane@example.com", role: "ADMIN", status: "active", createdAt: "2023-11-01", lastLogin: "5 min ago" },
    { id: "7", name: "Chris Lee", email: "chris@example.com", role: "USER", status: "active", createdAt: "2024-01-25", lastLogin: "1 week ago" },
    { id: "8", name: "Lisa Taylor", email: "lisa@example.com", role: "AUDITOR", status: "active", createdAt: "2024-01-18", lastLogin: "6 hours ago" },
];
